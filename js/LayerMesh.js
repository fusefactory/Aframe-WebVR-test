window.LayerMesh = function(baseTexture, layers = []){
  // textures
...
window.LayerMesh.prototype._getLayerMaterial = function(colorTexture, maskTexture, color){
  if(!color){
